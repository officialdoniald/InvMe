namespace BLL.Helper
{
    public static class AppConstants
    {
        ...
        /// </summary>
        public static string NotificationHubName { get; set; } = "invmenotificationhub";
        ...
        /// </summary>
        public static string ListenConnectionString { get; set; } = "Endpoint=sb://invmenamespace.servicebus.windows.net/;SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=K5pyr5pn7j0XRkplS2p5DwXLaBtLZP1zfYdbiYSYeJE=";
        ...
        /// news, sports, and weather. Or 
        /// ,
        /// 
        /// they can be tags that identify a user
        /// across devices.
        /// </summary>
        public static string[] SubscriptionTags { get; set; } = { "asd", "default" };
